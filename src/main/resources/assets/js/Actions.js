...
Actions.prototype.init = function () {
    ...
    // fpfei: disabled first save menu and renamed it to save as XML
    ...
    // custom actions for saving to and loading from uLearn
    ...
    this.addAction('loadUlearn...', function () {
        ui.showDialog(new UlearnLoadDialog(ui).container, 300, 230, true, true);
    });
